...
| `tools/fonts/AtkinsonHyperlegible-*.ttf` | Braille Institute of America | SIL Open Font License 1.1 (`tools/fonts/AtkinsonHyperlegible-OFL.txt`) |
| `tools/fonts/Inter-*.ttf` | Inter by Rasmus Andersson, the variable font from [google/fonts](https://github.com/google/fonts/tree/main/ofl/inter) pinned to wght 400 and 700 at opsz 14 with `fontTools.varLib.instancer` | SIL Open Font License 1.1 (`tools/fonts/Inter-OFL.txt`) |
| `tools/fonts/Literata-*.ttf` | Literata by TypeTogether, the variable font from [google/fonts](https://github.com/google/fonts/tree/main/ofl/literata) pinned to wght 400 and 700 at opsz 14 with `fontTools.varLib.instancer` | SIL Open Font License 1.1 (`tools/fonts/Literata-OFL.txt`) |
| `tools/fonts/OpenSans-*.ttf` | Open Sans by Steve Matteson, the variable font from [google/fonts](https://github.com/google/fonts/tree/main/ofl/opensans) pinned to wght 400 and 700 at wdth 100 with `fontTools.varLib.instancer` | SIL Open Font License 1.1 (`tools/fonts/OpenSans-OFL.txt`) |
| `tools/fonts/ShantellSans-*.ttf` | Shantell Sans by Shantell Martin and ArrowType, the variable font from [google/fonts](https://github.com/google/fonts/tree/main/ofl/shantellsans) pinned to wght 400 and 700 at BNCE 45, INFM 25 and SPAC 0 with `fontTools.varLib.instancer` | SIL Open Font License 1.1 (`tools/fonts/ShantellSans-OFL.txt`) |
| `main/ui/fonts/*.h` | Bitmaps generated from the fonts above by `tools/gen_font.py` | OFL 1.1 |
| `main/ui/icons_data.h` | Status band pictograms generated by `tools/gen_icons.py` from Material Symbols Outlined in [google/material-design-icons](https://github.com/google/material-design-icons), downloaded on demand to `build/material_symbols.ttf` and never committed | Apache-2.0 (`build/material_symbols_LICENSE.txt`, fetched alongside it) |
